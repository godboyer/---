...
> = {
  ...
  lease_search: () => import("./website/leasepage/component/HouseSearch.vue"),
  rent_order: () => import("./website/houseorder/index.vue"),
  rent_pay: () => import("./website/houseorder/payment.vue"),
  ...
  management_feedback: () => import("./admin/management/feedback/index.vue"),
